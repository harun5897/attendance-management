...
class PDF extends FPDF {
    ...
    public function Header() {
        ...
        $this->Cell(0, 8, 'Jl. asoka Bintan Inti Industrial Estate Logam, Pulau Bintan Riau Island', 0, 1, 'C');
        $this->Ln(5);
    ...
    public function Footer() {
        ...
        $this->Cell(0, 10, 'Mengetahui Manajer', 0, 1, 'R');
    }
}
...
while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
    $pdf->SetX($marginLeft); // Atur posisi tabel di tengah
